...
| 1.3.0 | 2024-05-23 | EVYD产品团队 | 新增GitHub Actions自动部署到AWS S3功能，提高部署效率 |
| 1.3.1 | 2025-02-15 | EVYD产品团队 | 优化部署流程，更新S3存储桶配置 |
| 1.4.0 | 2025-04-03 | EVYD产品团队 | 增强安全性和性能优化 |
| 1.4.1 | 2025-04-09 | EVYD产品团队 | 修复账号设置页面密码修改功能，解决按钮无法点击问题 |
...
| 自动部署版本 | 2024-05-23 | 新增GitHub Actions自动部署到AWS S3的功能，实现代码推送自动同步 |
| 安全加固版本 | 2025-04-03 | 增强安全性和性能优化 |
| 功能修复版本 | 2025-04-09 | 修复账号设置页面密码修改功能，确保用户可以正常更新密码 |
